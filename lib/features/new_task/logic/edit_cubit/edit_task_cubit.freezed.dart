...
/// @nodoc
abstract class $EditTaskStateCopyWith<T, $Res> {
  factory $EditTaskStateCopyWith(
          EditTaskState<T> value, $Res Function(EditTaskState<T>) then) =
      _$EditTaskStateCopyWithImpl<T, $Res, EditTaskState<T>>;
}

/// @nodoc
class _$EditTaskStateCopyWithImpl<T, $Res, $Val extends EditTaskState<T>>
    implements $EditTaskStateCopyWith<T, $Res> {
...
class __$$InitialImplCopyWithImpl<T, $Res>
    extends _$EditTaskStateCopyWithImpl<T, $Res, _$InitialImpl<T>>
...
abstract class _Initial<T> implements EditTaskState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$EditTaskStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'EditTaskState<$T>.loading()';
  }
...
abstract class Loading<T> implements EditTaskState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$EditTaskStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'EditTaskState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements EditTaskState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$EditTaskStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'EditTaskState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements EditTaskState<T> {
...
class __$$ImageSelectedImplCopyWithImpl<T, $Res>
    extends _$EditTaskStateCopyWithImpl<T, $Res, _$ImageSelectedImpl<T>>
...
class _$ImageSelectedImpl<T> implements ImageSelected<T> {
  ...
  @override
  String toString() {
    return 'EditTaskState<$T>.imageSelected(image: $image)';
  }
...
abstract class ImageSelected<T> implements EditTaskState<T> {
